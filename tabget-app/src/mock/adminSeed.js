...
const PENDING_POLLS = [
  {
    ...
    productA: {
      ...
      gallery: ['https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&q=80&w=800'],
    ...
    productB: {
      ...
      gallery: ['https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&q=80&w=800'],
  ...
  },
  {
    ...
    productB: {
      ...
      gallery: ['https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&q=80&w=800'],
...
const ARCHIVED_POLLS = [
  {
    ...
    productA: {
      name: 'MX Keys S',
      brand: 'Logitech',
      imageUrl: 'https://images.unsplash.com/photo-1541140532154-b024d705b90a?auto=format&fit=crop&q=80&w=800',
      gallery: [],
